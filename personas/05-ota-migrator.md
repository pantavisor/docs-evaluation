...
> You land on `https://docs.pantavisor.io/development/meta-pantavisor/getting-started/migrate` — specifically the page for
...
> Read `https://docs.pantavisor.io/development/meta-pantavisor/getting-started/migrate/mender` (or `.../migrate/rauc`), then
> follow it into whatever it points at — likely `https://docs.pantavisor.io/development/pantavisor/overview/updates` and
> `https://docs.pantavisor.io/development/pantavisor/overview/revisions`.
>
